...
class RustPlus extends RustPlusLib {
    constructor(guildId, serverIp, appPort, steamId, playerToken) {
        ...
        this.messagesSentByBot =
            []; /* Stores the last messages sent by the bot to the team chat */
    ...
    updateEvents(event, message) {
        const commandCargoEn = `${Client.client.intlGet(
            "en",
            "commandSyntaxCargo"
        )}`;
        const commandHeliEn = `${Client.client.intlGet("en", "commandSyntaxHeli")}`;
        const commandSmallEn = `${Client.client.intlGet(
            "en",
            "commandSyntaxSmall"
        )}`;
        const commandLargeEn = `${Client.client.intlGet(
            "en",
            "commandSyntaxLarge"
        )}`;
        const commandChinookEn = `${Client.client.intlGet(
            "en",
            "commandSyntaxChinook"
        )}`;
        if (
            ![
                commandCargoEn,
    ...
    logInGameCommand(type = "Default", message) {
        ...
        this.log(
            ...
            Client.client.intlGet(null, `logInGameCommand`, args)
        );
    }
    ...
    async setEntityValueAsync(id, value, timeout = 10000) {
        try {
            ...
            try {
                ...
                if (
                    value === payloadValue ||
                    (payloadValue === undefined && value === false)
                ) {
                    return { success: true };
                }
            } catch (ex) {
    ...
    async getCommandAi(command) {
        ...
        const commandAi = `${prefix}${Client.client.intlGet(
            this.guildId,
            "commandSyntaxAi"
        )}`;
        const commandAiEn = `${prefix}${Client.client.intlGet(
            "en",
            "commandSyntaxAi"
        )}`;
        let query = null;
    ...
    async getCommandQuery(command, source = 0) {
        ...
        const commandQueryEn = `${prefix}${Client.client.intlGet(
            "en",
            "commandSyntaxQuery"
        )}`;
        let query = null;
    ...
    getCommandCraft(command) {
        const prefix = this.generalSettings.prefix;
        const commandCraft = `${prefix}${Client.client.intlGet(
            this.guildId,
            "commandSyntaxCraft"
        )}`;
        const commandCraftEn = `${prefix}${Client.client.intlGet(
            "en",
            "commandSyntaxCraft"
        )}`;
        ...
        if (craftDetails === null) {
            const str = Client.client.intlGet(
                this.guildId,
                "couldNotFindCraftDetails",
                {
                    name: itemName,
                }
            );
    ...
    getCommandDecay(command) {
        const prefix = this.generalSettings.prefix;
        const commandDecay = `${prefix}${Client.client.intlGet(
            this.guildId,
            "commandSyntaxDecay"
        )}`;
        const commandDecayEn = `${prefix}${Client.client.intlGet(
            "en",
            "commandSyntaxDecay"
        )}`;
        ...
        if (!foundName) {
            foundName =
                Client.client.rustlabs.getClosestOtherNameByName(decayItemName);
            if (foundName) {
                if (
                    Client.client.rustlabs.decayData["other"].hasOwnProperty(foundName)
                ) {
                    type = "other";
                } else {
                    foundName = null;
        ...
        if (!foundName) {
            foundName =
                Client.client.rustlabs.getClosestBuildingBlockNameByName(decayItemName);
            if (foundName) {
                if (
                    Client.client.rustlabs.decayData["buildingBlocks"].hasOwnProperty(
                        foundName
                    )
                ) {
                    type = "buildingBlocks";
        ...
        if (!foundName) {
            ...
            if (foundName) {
                if (
                    !Client.client.rustlabs.decayData["items"].hasOwnProperty(foundName)
                ) {
                    foundName = null;
                }
            }
        ...
        if (details.decayString !== null) {
            ...
            if (hp === details.hp) {
                ...
                const time = Timer.secondsToFullScale(
                    Math.floor(details.decay * decayMultiplier)
                );
        ...
        if (details.decayOutsideString !== null) {
            ...
            if (hp === details.hp) {
                ...
                const time = Timer.secondsToFullScale(
                    Math.floor(details.decayOutside * decayMultiplier)
                );
                decayStrings.push(`${str}${time}`);
            }
        }
        ...
        if (details.decayInsideString !== null) {
            ...
            if (hp === details.hp) {
                ...
                const time = Timer.secondsToFullScale(
                    Math.floor(details.decayInside * decayMultiplier)
                );
                decayStrings.push(`${str}${time}`);
            }
        }
        ...
        if (details.decayUnderwaterString !== null) {
            ...
            if (hp === details.hp) {
                ...
                const time = Timer.secondsToFullScale(
                    Math.floor(details.decayUnderwater * decayMultiplier)
                );
                decayStrings.push(`${str}${time}`);
            }
        }
    ...
    getCommandDespawn(command) {
        const prefix = this.generalSettings.prefix;
        const commandDespawn = `${prefix}${Client.client.intlGet(
            this.guildId,
            "commandSyntaxDespawn"
        )}`;
        const commandDespawnEn = `${prefix}${Client.client.intlGet(
            "en",
            "commandSyntaxDespawn"
        )}`;
    ...
    getCommandEvents(command) {
        const prefix = this.generalSettings.prefix;
        const commandEvents = `${prefix}${Client.client.intlGet(
            this.guildId,
            "commandSyntaxEvents"
        )}`;
        const commandEventsEn = `${prefix}${Client.client.intlGet(
            "en",
            "commandSyntaxEvents"
        )}`;
        const commandCargo = `${Client.client.intlGet(
            this.guildId,
            "commandSyntaxCargo"
        )}`;
        const commandCargoEn = `${Client.client.intlGet(
        ...
        const commandHeli = `${Client.client.intlGet(
            this.guildId,
            "commandSyntaxHeli"
        )}`;
        const commandHeliEn = `${Client.client.intlGet("en", "commandSyntaxHeli")}`;
        const commandSmall = `${Client.client.intlGet(
            this.guildId,
            "commandSyntaxSmall"
        )}`;
        const commandSmallEn = `${Client.client.intlGet(
        ...
        const commandLarge = `${Client.client.intlGet(
            this.guildId,
            "commandSyntaxLarge"
        )}`;
        const commandLargeEn = `${Client.client.intlGet(
        ...
        const commandChinook = `${Client.client.intlGet(
            this.guildId,
            "commandSyntaxChinook"
        )}`;
        const commandChinookEn = `${Client.client.intlGet(
    ...
    getCommandLarge(isInfoChannel = false) {
        ...
        if (this.mapMarkers.crateLargeOilRigTimer) {
            const time = Timer.getTimeLeftOfTimer(
                this.mapMarkers.crateLargeOilRigTimer
            );
            if (time) {
                if (isInfoChannel) {
                    return Client.client.intlGet(this.guildId, "timeUntilUnlocksAt", {
                        time: Timer.getTimeLeftOfTimer(
                            this.mapMarkers.crateLargeOilRigTimer,
                            "s"
                        ),
                            ...
                            if (
                                (orderType === "all" &&
                                    (orderItemId === parseInt(itemId) ||
                                        orderCurrencyId === parseInt(itemId))) ||
            ...
            case commandUnsub:
                {
                    ...
                    if (instance.marketSubscriptionList[orderType].includes(itemId)) {
                        instance.marketSubscriptionList[orderType] =
                            instance.marketSubscriptionList[orderType].filter(
                                (e) => e !== itemId
                            );
                        Client.client.setInstance(this.guildId, instance);
            ...
            case commandList:
                {
                    ...
                    for (const [ot, itemIds] of Object.entries(
                        instance.marketSubscriptionList
                    )) {
                        let counter = 0;
                        for (const itemId of itemIds) {
                            if (counter === 0)
                                names[ot] += `${Client.client.intlGet(this.guildId, ot)}: `;
                            names[ot] += `${Client.client.items.getName(
                                itemId
                            )} (${itemId}), `;
                            counter += 1;
                        }
    ...
    getCommandPlayer(command) {
        ...
        if (!bmInstance || !bmInstance.lastUpdateSuccessful) {
            return Client.client.intlGet(
                this.guildId,
                "battlemetricsInstanceCouldNotBeFound",
                {
                    id: battlemetricsId,
                }
            );
        ...
        if (
            ...
            for (const playerId of bmInstance.getOnlinePlayerIdsOrderedByTime()) {
                if (bmInstance.players[playerId]["name"].includes(name))
        ...
        const trademarkString =
            trademark === "NOT SHOWING" ? "" : `${trademark} | `;
        const messageMaxLength =
            Constants.MAX_LENGTH_TEAM_MESSAGE - trademarkString.length;
    ...
    getCommandRecycle(command) {
        const prefix = this.generalSettings.prefix;
        const commandRecycle = `${prefix}${Client.client.intlGet(
            this.guildId,
            "commandSyntaxRecycle"
        )}`;
        const commandRecycleEn = `${prefix}${Client.client.intlGet(
            "en",
            "commandSyntaxRecycle"
        )}`;
    ...
    getCommandResearch(command) {
        const prefix = this.generalSettings.prefix;
        const commandResearch = `${prefix}${Client.client.intlGet(
            this.guildId,
            "commandSyntaxResearch"
        )}`;
        const commandResearchEn = `${prefix}${Client.client.intlGet(
            "en",
            "commandSyntaxResearch"
        )}`;
        ...
        const researchDetails =
            Client.client.rustlabs.getResearchDetailsById(itemId);
        if (researchDetails === null) {
            const str = Client.client.intlGet(
                this.guildId,
                "couldNotFindResearchDetails",
                {
                    name: itemName,
                }
            );
        ...
        if (researchDetails[2].researchTable !== null) {
            const researchTable = `${Client.client.intlGet(
                this.guildId,
                "researchTable"
            )}`;
        ...
        if (researchDetails[2].workbench !== null) {
            const type = `${Client.client.items.getName(
                researchDetails[2].workbench.type
            )}`;
    ...
    getCommandSmall(isInfoChannel = false) {
        ...
        if (this.mapMarkers.crateSmallOilRigTimer) {
            const time = Timer.getTimeLeftOfTimer(
                this.mapMarkers.crateSmallOilRigTimer
            );
            if (time) {
                if (isInfoChannel) {
                    return Client.client.intlGet(this.guildId, "timeUntilUnlocksAt", {
    ...
    getCommandStack(command) {
        const prefix = this.generalSettings.prefix;
        const commandStack = `${prefix}${Client.client.intlGet(
            this.guildId,
            "commandSyntaxStack"
        )}`;
        const commandStackEn = `${prefix}${Client.client.intlGet(
            "en",
            "commandSyntaxStack"
        )}`;
    ...
    getCommandSteamId(command, callerSteamId, callerName) {
        const prefix = this.generalSettings.prefix;
        const commandSteamid = `${prefix}${Client.client.intlGet(
            this.guildId,
            "commandSyntaxSteamid"
        )}`;
        const commandSteamidEn = `${prefix}${Client.client.intlGet(
            "en",
            "commandSyntaxSteamid"
        )}`;

        if (
            command.toLowerCase() === `${commandSteamid}` ||
            command.toLowerCase() === `${commandSteamidEn}`
        ) {
        ...
        if (strings.length === 0) {
            ...
            if (wasOnMap == null) {
                return isInfoChannel
                    ...
                    : Client.client.intlGet(
                        this.guildId,
                        "travelingVendorNotCurrentlyOnMap"
                    );
                ...
                if (isInfoChannel) {
                    ...
                    return Client.client.intlGet(
                        this.guildId,
                        "timeSinceTravelingVendorWasOnMap",
                        {
                            time: timeSince,
                        }
                    );
